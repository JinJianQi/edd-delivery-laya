...
export default class D3Main extends Laya.Script {
    ...
    onEnable(): void {
        ...
        this.spFatso = this.owner.getChildByName("spFatso") as Laya.Sprite;
    ...
    */
    _3Dto2D(lh: string, sp: Laya.Sprite, layer: number, isRole: boolean = false): void {
        //加载指定的模型，并画到2D精灵上
        Laya.Sprite3D.load(lh, Laya.Handler.create(this, (sp3: Laya.Sprite3D) => {
            //把指定的模型节点添加3D到场景上
