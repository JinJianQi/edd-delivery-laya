...
export default class Joystick extends Laya.Script {
    ...
    private runAniName: string = "Right,Rdown1,Rdown2,Rdown3,Down,Ldown3,Ldown2,Ldown1,Left,Lup1,Lup2,Lup3,Up,Rup3,Rup2,Rup1";
    ...
    onEnable(): void {
        ...
        //找到动画
        this.roleStand = this.roleAniNode.getChildByName("roleStand") as Laya.Animation;
        this.roleRun = this.roleAniNode.getChildByName("roleRun") as Laya.Animation;
    }
